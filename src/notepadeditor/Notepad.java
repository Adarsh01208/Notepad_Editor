...
{   
    ...
    public Notepad()
   {
      ...
      catch(Exception e)
      {
       ...
       Image icon= Toolkit.getDefaultToolkit().getImage("C:\\Users\\adars\\Documents\\NetBeansProjects\\NotepadEditor\\src\\notepadeditor\\ntpd.png");
       ...
       file.addSeparator();
        ...
        page_Setup=new JMenuItem("Page_Setup");
        page_Setup.setAccelerator(KeyStroke.getKeyStroke('P',InputEvent.SHIFT_DOWN_MASK));
